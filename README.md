...
#### Команда імпорту XML (Tests\Command\ImportXmlCommandTest)
- Успішний імпорт
- Імпорт з відсутнім файлом
- Імпорт з некоректною структурою XML
- Імпорт з некоректними даними товару
- Імпорт з пустими пропозиціями
- Імпорт з нульовим ідентифікатором

#### Сервіс фільтрації Redis (Tests\Service\RedisFilterServiceTest)
- Ключі Redis після імпорту
- Отримання відфільтрованих товарів
- Отримання значень параметрів
- Отримання статистики параметрів
- Отримання статистики каталогу
- Пагінація
- Сортування
